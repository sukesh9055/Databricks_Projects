...
display(spark.sql(f"SELECT * FROM `bronze`.`raw_traffic`"))

# COMMAND ----------

display(spark.sql(f"SELECT * FROM `bronze`.`raw_roads`"))

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM `bronze`.`raw_traffic`

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM `bronze`.`raw_roads`